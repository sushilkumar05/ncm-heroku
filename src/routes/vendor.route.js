...
router.patch('/id/:id', auth(Role.Admin), updateVendorSchema, awaitHandlerFactory(vendorController.updateVendor)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(vendorController.deleteVendor)); // localhost:3000/api/v1/countries/id/1
