...
router.patch('/id/:id', auth(), updateJobMasterSchema, awaitHandlerFactory(jobMasterController.updateJobMaster)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(), awaitHandlerFactory(jobMasterController.deleteJobMaster)); // localhost:3000/api/v1/countries/id/1
