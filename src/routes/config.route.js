...
router.patch('/id/:id', auth(Role.Admin), updateConfigSchema, awaitHandlerFactory(configController.updateConfig)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(configController.deleteConfig)); // localhost:3000/api/v1/countries/id/1
