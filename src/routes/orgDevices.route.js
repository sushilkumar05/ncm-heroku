...
router.patch('/id/:id', auth(), updateOrgDevicesSchema, awaitHandlerFactory(orgDevicesController.updateOrgDevices)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(), awaitHandlerFactory(orgDevicesController.deleteOrgDevices)); // localhost:3000/api/v1/countries/id/1
