...
router.patch('/id/:id', auth(Role.Admin), updateRoleEntitySchema, awaitHandlerFactory(roleEntityController.updateRoleEntity)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(roleEntityController.deleteRoleEntity)); // localhost:3000/api/v1/countries/id/1
