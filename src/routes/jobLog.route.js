...
router.patch('/id/:id', auth(), updateJobLogSchema, awaitHandlerFactory(jobLogController.updateJobLog)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(), awaitHandlerFactory(jobLogController.deleteJobLog)); // localhost:3000/api/v1/countries/id/1
