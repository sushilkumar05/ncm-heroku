...
router.patch('/id/:id', auth(Role.Admin), updateRoleDetailSchema, awaitHandlerFactory(roleDetailsController.updateRoleDetails)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(roleDetailsController.deleteRoleDetails)); // localhost:3000/api/v1/countries/id/1
