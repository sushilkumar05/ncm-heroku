...
router.patch('/id/:id', auth(), updateOrganizationSchema, awaitHandlerFactory(organizationController.updateOrganization)); // localhost:3000/api/v1/countries/id/1 , using patch for partial update
router.delete('/id/:id', auth(), awaitHandlerFactory(organizationController.deleteOrganization)); // localhost:3000/api/v1/countries/id/1
